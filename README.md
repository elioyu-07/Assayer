...
- 下一阶段按[真实浏览器与 MCP 集成计划](docs/browser-mcp-integration-plan.md)推进：B07a 真实结构化 Evidence 与 B07b 真实对象级截图已完成；B07c 自动敏感区域识别与像素脱敏暂缓；当前推进 B08 通用 JSON CLI 与 MCP 传输。
