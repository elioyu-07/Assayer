#!/usr/bin/env python3
"""Prove the M4 exit gate for the external Spec-quality plugin end to end.

Journey against the real ``plugins/spec-quality`` distribution, using a durable
...
The platform never imports ``assayer_spec_quality``; it only loads the package
    ...
    try:
        ...
        result = {
            ...
            "result": {
                ...
                "message": "The external Spec-quality exit-gate journey did not complete.",
            },
        }
    schema = json.loads(
